...
В архиве вы найдете 4 файла: образ корневой ФС и ядро, а также контрольные суммы к ним. Разархивируйте их на вашу карту памяти. Туда же добавьте файл скрипта для установки. Поместите карту памяти с файлами в слот камеры. Подключите UART, запустите программу-терминал и подайте питание на камеру. Вы сможете видеть, как произойдет прошивка Вашей камеры в автоматическом режиме.
