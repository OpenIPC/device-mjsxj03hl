...
В папке https://github.com/OpenIPC/builder/releases вы найдете самые свежие релизы OpenIPC для своего устройства.
...
В архиве вы найдете 4 файла: образ корневой ФС и ядро, а также контрольные суммы к ним. Разархивируйте их на вашу карту памяти и поместите ее в слот камеры.
