...
![изображение](https://user-images.githubusercontent.com/88727968/230729874-26039cff-8b14-46d2-906a-f7aae7f4d834.png)
...
Если это неприемлимо, или у вас не имеется MicroSD карты - выполните настройку вручную по [устаревшей версии мануала](https://github.com/OpenIPC/device-mjsxj03hl/blob/master/old_setting_up_ru.md)
...
Отредактируйте файл **interfaces**, лежащий по пути **~/etc/network** - замените `SSID` и `PASSWORD` на параметры Вашей точки доступа.
